...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Runtime: " + runtime + " microseconds." );
		System.out.println("Original File Size: " + initialFile.length()/1024 + " kilobytes.");
		...
		decoded.write(codingTree.decode());
		decoded.close();
	 ...
	 * @throws Exception 
	 */
	public static void testCodingTree(String text) throws Exception {
		...
		System.out.println("Decoded message: " + c.decode());
	}
